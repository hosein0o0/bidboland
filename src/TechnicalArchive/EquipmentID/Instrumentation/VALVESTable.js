...
export default class VALVESTable extends Component {
  constructor (props) {
    super(props)
    this.state = {
      ...
      header: [
        ...
        { name: 'MFR & Model (Solenoid)', value: 'mdr_and_model_solenoid' },
        { name: 'Order No. (Solenoid)', value: 'order_no_solenoid' },
        {
          name: 'MFR & Model (Limit Switch)',
          value: 'mdr_and_model_limit_switch'
        },
        {
          name: 'Order No. (Limit Switch)',
          value: 'order_no_solenoid_limit_switch'
        },
        { name: 'MFR & Model (Positioner)', value: 'mdr_and_model_positioner' },
        {
          name: 'Order No. (Positioner)',
          value: 'order_no_solenoid_positioner'
        },
        { name: 'MFR & Model (Actuator)', value: 'mdr_and_model_actuator' },
        { name: 'Order No. (Actuator)', value: 'order_no_solenoid_actuator' },
        ...
        { name: 'Plant Initial Calibration Certificate', value: 'Plant' }
      ],
      row: [],
      contentPerPage: 25,
      page: 1,
  ...
  handleSearch = async text => {
    if (this.state.token) {
      ...
      // }
      // await axios.get(`${StaticData.domainIp}/pfd/getList/${this.state.page}?contentPerPage=${this.state.contentPerPage}&searchInAll=${text}`, {
      //     headers: {
  ...
  fetchData = async (text = null) => {
    if (this.state.token) {
      // let url = ''
      // if (text !== null) {
      //     url = `${StaticData.domainIp}/pfd/getList/${this.state.page}?contentPerPage=${this.state.contentPerPage}&${text}`
      // } else {
      //     url = `${StaticData.domainIp}/pfd/getList/${this.state.page}?contentPerPage=${this.state.contentPerPage}`
      // }
            ...
            <div className='col-xl-5 col-lg-5 col-md-12 col-12 d-flex align-items-center'>
              <div className='link-footer'>
                <a
                  ...
                  //     this.state.search,
                  //     `${StaticData.domainIp}/pfd/exportExcel`)}
                  href='#/'
                  target='_blank'
                  rel='noreferrer'
                  className='xls'
                ...
                <a
                  ...
                  //     this.state.textSearch,
                  //     this.state.search,
                  //     `${StaticData.domainIp}/pfd/exportPdf`)}
                  href='#/'
                  target='_blank'
                  rel='noreferrer'
                  className='pdf'
