...
import Action3DModel from './Action3DModel'
...
export default class Model3D extends Component {
  constructor (props) {
    ...
    this.state = {
      ...
      header: [
        ...
        { name: 'Rev', value: 'rev', download: true },
  ...
  handleSearch = async text => {
    ...
    if (token) {
      ...
      fetchDataAPI(url, 'handle3DModelLink')
    }
  }
      ...
      <React.Fragment>
        <div className='table w-100'>
          <table>
            ...
            <BodyTable
              nameDownload='3d_model_download'
              {...this}
              objLink={{
                rev: 'url'
              }}
              action={data => <Action3DModel {...this} data={data} />}
            />
          </table>
        </div>
        <FooterTable
          ...
          xlsName='3d_model_export'
          pdf={`${baseUrlAPI}/exportPdf`}
          pdfName='3d_model_export'
        />
      </React.Fragment>
    )
  }
