...
export default class InstrumentFormEdit extends Component {
  constructor (props) {
    super(props)
  ...
  componentDidMount () {
    document.title = `${StaticData.Title} - ویرایش instrument`
    this.GetId()
  }
  GetId = async () => {
  ...
  fetchData = async id => {
    if (this.state.token) {
      let url = `${StaticData.domainIp}/instrumentList/get/${id}`
      await axios
        .get(url, {
          headers: {
  ...
  handleSubmit = async () => {
    ...
    if (check && id) {
      ...
      await axios({
        method: 'post',
        url: `${StaticData.domainIp}/instrumentList/update/${id}`,
        data: datareg,
        headers: {
        ...
        <div className='main'>
          <div className='col-12 p-0'>
            <div className='row m-0'>
              ...
              >
                <Menu nameRole='instrument_edit' nameUrl={this.props.nameUrl} />
                <div className='w-100 row m-0 main-box-dashboard'>
                  <div className='boxes-dashboard row m-0 p-0'>
                    <div className='main-form'>
                      <div className='title-from'>
                        <h2>ویرایش instrument</h2>
                      </div>
