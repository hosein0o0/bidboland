...
export default class CCS extends Component {
  constructor (props) {
    super(props)
    this.Search = null
    this.Reset = null
  ...
  componentDidMount () {
    document.title = `${StaticData.Title} - برگ نظرات راه اندازی`
