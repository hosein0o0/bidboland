...
export default class PAndIDForm extends Component {
  constructor (props) {
    super(props)
  ...
  componentDidMount () {
    document.title = `${StaticData.Title} - ایجاد P&ID`
  }
  OnFocus = name => {
  ...
  handleSubmit = async () => {
    ...
    if (check) {
      ...
      await axios({
        method: 'post',
        url: `${StaticData.domainIp}/PAndId/create`,
        data: datareg,
        headers: {
          Authorization: this.state.token ? `Bearer ${this.state.token}` : null
        }
        ...
        <div className='main'>
          <div className='col-12 p-0'>
            <div className='row m-0'>
              ...
              >
                <Menu nameRole='p&id_create' nameUrl={this.props.nameUrl} />
