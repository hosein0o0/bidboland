...
// import EngineeringRoundedIcon from '@material-ui/icons/EngineeringRounded';
...
export default class DashboardPars extends Component {
  constructor (props) {
    super(props)
    this.state = {
      boxes: [
        ...
        {
          text: 'مدیریت ساخت، نصب و راه‌اندازی',
        ...
        {
          text: 'مدیریت ایمنی، بهداشت و محیط‌زیست',
