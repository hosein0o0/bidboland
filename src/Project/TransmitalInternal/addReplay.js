...
export default class AddReplay extends Component {
  ...
  componentDidMount () {
    // this.setState({ReplayList : this.props.state.ReplayList})
  }
            ...
            >
              <div className='col p-0'>
                ...
                <textarea
                  ...
                  readOnly={this.props.props.readOnly}
                  onFocus={e =>
                    this.props.props.readOnly
                      ? ''
                  ...
                  onChange={e =>
                    this.props.props.readOnly ? '' : this.props.handleChange(e)
                  }
                  onBlur={() =>
                    this.props.props.readOnly ? '' : this.props.OnBlur()
                  }
                ></textarea>
              </div>
            </div>
            ...
            <div className={`field-form`}>
              ...
              <div
                className={`allName english col row m-0 justify-content-end ${
                  this.props.props.readOnly ? 'pr-2' : ''
                }`}
              >
                {this.props.props.readOnly ? (
