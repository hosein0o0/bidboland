...
export default class CommentSheet extends Component {
  ...
  handleSubmit = async status => {
    ...
    if (checkStatus && check) {
      this.setState({
        disabledButton: true,
        loading: status === 'continue' ? 'submit-continue' : 'submit'
      })
      setTimeout(async () => {
        ...
        await datareg.append(
          'momDate',
          getCustomFormat(this.state.momDate, true)
        )
      ...
      if (this.state.disabled) {
        if (
          this.Permision.handlePermision(
            this.state.role,
            'internal_transmittal_comment_sheet_edit'
          )
        ) {
          return (
            ...
            <div className='col-xl-6 col-lg-6 col-md-12 col-12'>
              ...
              >
                ...
                <input
                  ...
                  className='text-left'
                  name='documentTitle'
                  value={handleString(this.state.documentDetail.documentTitle)}
                />
              </div>
            </div>
            <div className='col-xl-6 col-lg-6 col-md-12 col-12'>
