            ...
            if (response.data.content.readonly) {
              let replyDetail = Object.keys(
                ...
                response.data.content.replyDetail[
                  ...
                  return response.data.content.replyDetail[item].AttachmentFile[
                    file
                  ]
                })
                response.data.content.replyDetail[
              ...
              let detail = Object.keys(response.data.content.detail).map(
                (_item, key) => {
                  response.data.content.detail[_item].replay = replyDetail[key]
                  return response.data.content.detail[_item]
                }
              )
              this.setState({ detail: detail })
            } else {
              if (
                !response.data.content.detail ||
                response.data.content.detail === null ||
                response.data.content.detail === ''
              ) {
                response.data.content.detail = {}
                response.data.content.detail[0] = {}
                response.data.content.detail[0].replay = {
                  statusComment: 'NA',
                  text: '',
                  AttachmentFile: [],
                  AttachmentFileName: [],
                ...
                this.setState({
                  detail: [response.data.content.detail[0]]
                })
              } else {
              ...
              for (let item2 in response.data.content.replyDetail) {
                ...
                for (let native2 in response.data.content.replyDetail[item2]
                  ...
                  await nativeList2.push(
                    response.data.content.replyDetail[item2].NativeFile[native2]
                  )
                }
                response.data.content.replyDetail[
                  item2
      ...
      if (this.state.redirect) {
        ...
        return (
          <div className='form row justify-content-start ltr'>
            <div className='col-xl-6 col-lg-6 col-md-12 col-12'>
              <div
                className={`field-form data ${
                  this.state.foucs === 'CommentNO' || this.state.CommentNO
                    ? 'active'
                    : ''
                }`}
              >
            ...
            <div className='col-xl-6 col-lg-6 col-md-12 col-12'>
              <div
                className={`field-form ${
                  this.state.foucs === 'replyNo' || this.state.replyNo
                    ? 'active'
                    : ''
                }`}
              >
            ...
            <div className='col-xl-6 col-lg-6 col-md-12 col-12'>
              <div
                className={`field-form ${this.state.MomDate ? 'active' : ''}`}
              >
            ...
            <div className='col-xl-6 col-lg-6 col-md-12 col-12'>
              <div className={`field-form ${this.state.MOM ? 'active' : ''}`}>
            ...
            <div className='col-xl-6 col-lg-6 col-md-12 col-12'>
              <div className={`field-form ${this.state.LetNo ? 'active' : ''}`}>
                <label>LET No</label>
                <input
                  className='text-left'
                  name='LetNo'
      ...
      return this.state.array.map((data, i) => (
        <div className='col-12 row m-0' key={i}>
          <div className='w-100'>
              ...
              <div className='col-xl-12 col-lg-12 col-md-12 col-12 p-0'>
                <div
                  className={`field-form textarea ltr ${
                    handleCheckText(data.text) ? 'active' : ''
                  }`}
                >
                  <div className='col p-0'>
            ...
            {data.AttachmentFile && data.AttachmentFileName ? (
              <div className='col-xl-12 col-lg-12 col-md-12 col-12 p-0'>
            ...
            {data.NativeFile && data.NativeFileName ? (
              <div className='col-xl-12 col-lg-12 col-md-12 col-12 p-0'>
                <div className={`field-form`}>
