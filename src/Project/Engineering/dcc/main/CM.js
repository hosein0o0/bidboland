            ...
            <div className='w-100 row m-0 main-list-from' key={i}>
              ...
              <div className='col-xl-12 col-lg-12 col-md-12 col-12 p-0'>
                <div className={`field-form`}>
                  ...
                  >
                    {/* {this.props.disabled?
                    this.Convertor(data.AttachmentFile , data.AttachmentFileName).map((file , index)=>
                        <a href={file.link} key={index} target='_blank' rel='noreferrer'>
                            <span>{file.link}</span>
                        </a>
                    )
                    : */}
                    {this.Convertor(
                      ...
                      <span key={index}>
                        ...
                        <a href={file.link} target='_blank' rel='noreferrer'>
                          <span className='p-0'>{handleString(file.link)}</span>
                        </a>
                      </span>
                    ))}
                  </div>
              ...
              <div className='col-xl-12 col-lg-12 col-md-12 col-12 p-0'>
                <div className={`field-form`}>
                  ...
                  >
                    {/* {this.props.disabled?
                    this.Convertor(data.NativeFile , data.NativeFileName).map((file , index)=>
                        <a href={file.link} key={index} target='_blank' rel='noreferrer'>
                            <span>{file.link}</span>
                        </a>
                    )
                    ...
                    {this.Convertor(data.NativeFile, data.NativeFileName).map(
                      (file, index) => (
                        <span key={index}>
                          ...
                          />
                          <a href={file.link} target='_blank' rel='noreferrer'>
                            <span className='p-0'>{file.link}</span>
                          </a>
                        </span>
                      )
                    )}
