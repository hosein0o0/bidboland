...
export default class TransmittalDisabled extends Component {
  ...
  handleSubmit = async (status, message) => {
    if (this.state.token) {
      ...
      await axios({
        method: 'post',
        url: `${StaticData.domainIp}/vendorTransmittal/verify/${this.state.id}`,
        data: datareg,
        headers: {
                  ...
                  <div className='col-xl-6 col-lg-6 col-md-12 col-12'>
                    ...
                    >
                      ...
                      >
                        ...
                        <option value='I'>I (For Information)</option>
                        <option value='R'>R (For Review)</option>
                        <option value='B'>B (As Built)</option>
                        <option value='C'>C (for Construction)</option>
                      </select>
                    </div>
                  </div>
                  <div className='col-xl-6 col-lg-6 col-md-12 col-12'>
