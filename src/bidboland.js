...
import DetailedEngineeringFormEdit from './TechnicalArchive/DetailedEngineeringFormEdit'
...
import DCC from './EngineeringManagement/DCC'
import ProjectIdentifyForm from './WBS/ProjectIdentifyForm'
import ProjectIdentifyEdit from './WBS/ProjectIdentifyEdit'
import ReportTsr from './tsrNew/report'
const Routes = (
  <Router>
    <Switch>
      <Route
      ...
      <Route
        exact
        path='/detailEng-:id'
        nameUrl='DetailedEngineeringFormEdit'
        render={props => {
          let merge = {
            ...props,
            ...{ nameUrl: 'DetailedEngineeringFormEdit' }
          }
          return <DetailedEngineeringFormEdit {...merge} />
        }}
      />
      <Route
        exact
      ...
      <Route
        ...
        nameUrl='ReportTsr'
        render={props => {
          let merge = { ...props, ...{ nameUrl: 'ReportTsr' } }
          return <ReportTsr {...merge} />
        }}
      />
      ...
      <Route
        ...
        nameUrl='DCC'
        render={props => {
          let merge = { ...props, ...{ nameUrl: 'DCC' } }
          return <DCC {...merge} />
        }}
      />
      <Route
        exact
        path='/project-identify-create'
        nameUrl='ProjectIdentifyForm'
        render={props => {
          let merge = { ...props, ...{ nameUrl: 'ProjectIdentifyForm' } }
          return <ProjectIdentifyForm {...merge} />
        }}
      />
      <Route
        exact
        path='/project-identify-:id'
        nameUrl='ProjectIdentifyEdit'
        render={props => {
          let merge = { ...props, ...{ nameUrl: 'ProjectIdentifyEdit' } }
          return <ProjectIdentifyEdit {...merge} />
        }}
      />
      ProjectIdentifyEdit
      <Redirect to='/404' />
