...
export default class BasicEngineering extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      header: [
        { name: 'row', value: 'id' },
        { name: 'standard', value: 'publisher' },
        { name: 'Title', value: 'title' },
        { name: 'Subtitle', value: 'subtitle' },
        { name: 'Year', value: 'year', check: true }
      ],
      row: [],
      contentPerPage: 25,
      page: 1,
  ...
  componentDidMount() {
    ...
    this.props.getFetchData(this.fetchData)
    this.props.ChildState(this.handleState)
    this.fetchData()
      ...
      <React.Fragment>
        <div className='table w-100'>
          <table>
            ...
            <BodyTable
              {...this}
              action={data => <ActionLibrary {...this} data={data} />}
            />
          </table>
        </div>
        <FooterTable
          ...
          xlsName='standard_bank_export'
          pdf={`${baseUrlAPI}/exportPdf`}
          pdfName='standard_bank_export'
        />
      </React.Fragment>
    )
  }
