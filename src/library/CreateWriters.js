...
export default class CreateWriters extends Component {
  constructor (props) {
    super(props)
  ...
  componentDidMount () {
    document.title = `${StaticData.Title} - ایجاد نویسندگان`
  }
  OnFocus = name => {
  ...
  handleSubmit = async status => {
    ...
    if (check) {
      ...
      let url = `${StaticData.domainIp}/LibraryManager/author/create`
      await axios({
        method: 'post',
        url: url,
        data: datareg,
