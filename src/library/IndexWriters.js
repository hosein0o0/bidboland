...
import TableWriters from './TableWriters'
...
export default class IndexWriters extends Component {
  constructor (props) {
    super(props)
    this.Search = null
    this.Reset = null
  ...
  componentDidMount () {
    document.title = `${StaticData.Title} - نویسندگان`
