...
export default class Province extends Component {
  ...
  handleSubmit = async () => {
    if (this.state.name !== '') {
      ...
      await axios({
        method: 'post',
        url: `${StaticData.domainIp}/city/createProvince`,
        data: datareg,
        headers: {
...
class Table extends Component {
  ...
  handleSearch = async text => {
    if (this.state.token) {
      ...
      await axios
        .get(
          `${StaticData.domainIp}/city/getProvinceList/${this.state.page}?contentPerPage=${this.state.contentPerPage}&searchInAll=${text}`,
          {
            headers: {
  ...
  fetchData = async () => {
    if (this.state.token) {
      ...
      await axios
        .get(
          `${StaticData.domainIp}/city/getProvinceList/${this.state.page}?contentPerPage=${this.state.contentPerPage}`,
          {
            headers: {
              Authorization: `Bearer ${this.state.token}`
            }
    ...
    return (
      <React.Fragment>
        ...
        {this.state.row.length === 0 && this.state.search === '' ? (
          ...
          >
            <div className='col-xl-12 col-lg-12 col-md-12 col-12 align-items-center row m-0 justify-content-end mt-5'>
              <div className='main-item-footer mt-5'>
