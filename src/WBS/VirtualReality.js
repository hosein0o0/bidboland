...
export default class VirtualReality extends Component {
  constructor (props) {
    ...
    this.state = {
      ...
      header: [
        { name: 'Row', value: 'id' },
        { name: 'Unit/SYSTEM', value: 'unit_system' },
        { name: 'DISCRIPTION', value: 'description' },
        { name: 'CATEGORY', value: 'category' },
        { name: 'TAG.NO', value: 'tag_no', download: true }
      ],
      row: [],
      contentPerPage: 25,
      page: 1,
  ...
  handleSearch = async text => {
    ...
    if (token) {
      ...
      fetchDataAPI(url, 'VitualRealityLink')
    }
  }
      ...
      <React.Fragment>
        <div className='table w-100'>
          <table>
            ...
            />
            <BodyTable
              nameDownload='virtual_reality_download'
              {...this}
              objLink={{
                tag_no: 'url'
              }}
        ...
        <FooterTable
          ...
          xlsName='virtual_reality_export'
          pdf={`${baseUrlAPI}/exportPdf`}
          pdfName='virtual_reality_export'
        />
      </React.Fragment>
    )
  }
