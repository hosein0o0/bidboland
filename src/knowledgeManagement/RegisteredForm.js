...
export default class RegisteredForm extends Component {
  constructor (props) {
    super(props)
  ...
  componentDidMount () {
    document.title = `${StaticData.Title} - ایجاد درس آموخته`
    let dateIn = getCustomFormat(moment(), false)
    this.setState({
      date_submission: dateIn
    })
  }
  OnFocus = name => {
