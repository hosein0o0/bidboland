...
class APIFields {
    ...
    handleClick = (e, indexParent, field) => {
        ...
        const { setListSelected, listSelected, stateHook, setStateHook, API } = this.data
    ...
    handleManagment = (e, field) => {
        ...
        const { selected, stateHook, setStateHook, indexParent, setListSelected, listSelected, API } = this.data
        const { handleArray } = API
